...
# 4.0.1
__fixed__
- Fixed `@bitcoinerlab/secp256k1` dependency version (used `ecurve`) (#1139)
...
- `ECPair` (and all ECDSA code) now uses [`@bitcoinerlab/secp256k1`](https://github.com/bitcoinjs/@bitcoinerlab/secp256k1), which uses the [`libsecp256k1` library](https://github.com/bitcoin-core/secp256k1) (#1070)
...
- Removed dependency `bigi`, uses `bn.js` internally now (via `@bitcoinerlab/secp256k1`) (#1070, #1112)
