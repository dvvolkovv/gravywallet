...
This library uses [@bitcoinerlab/secp256k1](https://github.com/bitcoinjs/@bitcoinerlab/secp256k1), which uses [RFC6979](https://tools.ietf.org/html/rfc6979) to help prevent `k` re-use and exploitation.
